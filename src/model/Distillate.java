...
public class Distillate {
    ...
    public Distillate(int destillat_ID, LocalDate startDate, LocalDate endDate, String employeeName, String farmerName,
                      String fieldName, String grainType, String maltBatch, double volume, double alcoholPercentage) {
        this.distillateID = destillat_ID;
